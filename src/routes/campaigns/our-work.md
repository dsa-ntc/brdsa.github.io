...
<h2> 🚌🚇Reliable Public Transit </h2>

Baton Rouge DSA is currently embarking on a mission to fix the broken public transit system in East Baton Rouge. Our demands include better working conditions, pay, and benefits for bus drivers, higher standards of competency for CATS board members, and greater input from bus riders. These demands and others are the base on which better and ecological public transit can be built. 
...
[Famine Is The Enemy (FITE)](/fite/) is an independent mutual aid organization run mostly by Baton Rouge DSA members (but you don't have to be a DSA member to participate!). It serves food and donated clothing each Saturday from 12-1pm at [1410 Convention Street](https://maps.app.goo.gl/Z27zpujqKZCdw9fb9). FITE is interested in expanding its work into other forms of mutual aid rooted in collaboration, community education, and collective empowerment. [Donate and learn more here.](/fite/)

<h2> 🏠⚖️ Tenant Rights </h2>
